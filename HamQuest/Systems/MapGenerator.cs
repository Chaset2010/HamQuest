    ...
    public class MapGenerator {
        ...
        public DungeonMap CreateMap() {
            ...
            for (int r = _maxRooms; r > 0; r--) {
                ...
                int roomXPosition = Game.Random.Next(0, _width - roomWidth);
                int roomYPosition = Game.Random.Next(0, _height - roomHeight);
            ...
            //Iterate through each room that we want placed
